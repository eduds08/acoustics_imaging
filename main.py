...
if dados == 'acude':
    ...
    input_test.select_bscan_interval(min_time=5410000, max_time=5850000)  # Seleciona a porção do b-scan que deseja simular
    # input_test.plot_bscan()
...
# Grid em metros
size_meters_z = np.float32(15)
size_meters_x = np.float32(40)  # Não deixar abaixo de 40e-3 para os testes do panther. Os microfones ocupam 38.4e-3 metros.
...
if dados == 'acude':
    ...
    tr_sim.run(generate_video=False, animation_step=5)
elif dados == 'panther':
