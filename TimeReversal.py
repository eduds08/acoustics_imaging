    ...
    def run(self, generate_video: bool, animation_step: int):
        ...
        for i in range(self.total_time):
            ...
            if generate_video and i % animation_step == 0:
                save_image(self.p_future, f'{self.frames_folder}/frame_{i}.png')
        ...
        if generate_video:
            create_video(total_time=self.total_time, animation_step=animation_step, image_size=self.grid_size_shape, frame_path=self.frames_folder, output_path=f'{self.folder}/tr.mp4')
